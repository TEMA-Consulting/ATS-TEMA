    ...
    return (
        <Container sx={{ py: 8, display: "flex", justifyContent: "center" }}>
            <Card sx={{
                ...
                <Box>
                    <Typography variant="h1" gutterBottom>¡Registro Exitoso!</Typography>
                    <Typography variant="body1">Tu perfil ha sido creado correctamente en nuestro sistema</Typography>
                </Box>
